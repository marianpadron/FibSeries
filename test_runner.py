...
def build_row(n: int) -> str:
    ...
    if FORMAT == "markdown":
        return f"| {n:<3} | {iterative.center(11, ' ')} | {recursive.center(11, ' ')} | {dynamic_programming.center(22, ' ')} |" \
            + f"{iterative_p.center(12, ' ')} | {recursive_p.center(11, ' ')} | {dynamic_programming_p.center(22, ' ')} |"
